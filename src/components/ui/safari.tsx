...
// Demo
function useResponsiveSize(aspectRatio: number, preferWidth = false) {
...
export function SafariDemo() {
  const size = useResponsiveSize(1203 / 753, true)
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-4">
      <Safari
        ...
        height={size.height}
        url="shadcn.io"
        imageSrc="https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1600&h=1000&fit=crop"
      />
    </div>
  )
}
